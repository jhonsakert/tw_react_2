...
const Imp24 = () => {
    ...
    const handleClearAll = () => {
      setInputValues(Array(24).fill("")); // Очищаем все поля
    };
    ...
    return (
      <div>
        <div className="relative flex flex-col flex-grow w-full h-full pt-2 md:max-w-[876px] m-auto">
          ...
          <div className="bg-backgroundPrimary border border-line rounded p-6 mb-12">
          <div className="w-full flex items-center justify-between space-x-4">
            ...
            <h2
              ...
              className="font-semibold text-[26px] flex justify-center pt-[20px]"
            >
            ...
            <div className="w-full mt-6 flex flex-col space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <div className="flex w-full max-w-[744px]">
                    <div className="w-full flex justify-center">
                      <div className="relative w-[400px] mt-1 bg-gray-100 rounded-md py-[10px] pl-[15px] ">
                        <button
                ...
                <div className="flex w-full items-center justify-between mt-6 space-x-4 ">
                    <Link to="/imp">
                      <button
                        type="button"
                        className="outline-none bg-transparent text-backgroundPrimary default-button pl-[150px] w-full"
                      >
                        <p className="title-text text-primary font-medium text-[#0500FF]">
                          Назад
                        </p>
