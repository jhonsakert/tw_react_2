...
const Step1 = () => {
  ...
  const renderIcon = (condition) => (
    <div
      className={`flex items-center justify-center w-5 h-5 rounded-full border ${condition ? 'bg-[#0500FF] border-[#0500FF]' : 'border-gray-300'
        }`}
    >
      {condition && (
        <svg
      ...
      <div className="bg-backgroundPrimary border border-line rounded p-6 mb-11 m-auto md:max-w-[438px]">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p className="title-text text-textSecondary font-normal text-unset">
            Этот пароль используется для защиты вашего кошелька. Его нельзя сбросить, он находится
            отдельно от мобильного кошелька.
          </p>
          <div className="w-full mt-6 flex flex-col space-y-6">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex flex-col space-y-2">
                <div data-testid="password-field-input-group" className="text-start">
                  <p data-testid="input-label" className="body-text text-textPrimary font-medium text-unset">
              ...
              <div className="flex justify-center">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="m3j5g" className="ml-2 text-textPrimary subtitle-text font-normal text-[14px]">
              ...
              <div className="flex w-full items-center justify-between mt-6 space-x-4">
                <Link to="/">
                  <button type="button" className="outline-none bg-transparent text-backgroundPrimary default-button p-0 w-full">
                    <p className="title-text text-primary font-medium text-unset text-[#0500FF]">Назад</p>
                  </button>
                </Link>
                <Link to="/main">
                  <button
                    ...
                    className={`outline-none w-[180px] p-[10px] rounded-full text-white ${isSubmitEnabled ? 'bg-[#0500FF]' : 'opacity-100'}`}
